...
// the structures in this file were taken from https://wiki.osdev.org/AHCI
...
// command header, 32 of these form the command list
...
// FIS receive area for a port, pointed to by HBA_PORT.fb/fbu
typedef struct tagHBA_FIS {
    ...
    // 0xA0
    uint8_t        rsv[96];  // Reserved, room for the port's total 256 bytes
